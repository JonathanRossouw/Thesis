...
class Updater(BaseModel):
    ...
    def do_update(self,  environment,  time):
        ...
        self.endow_deposits(environment, time)
    ...
    # -------------------------------------------------------------------------
    def endow_deposits(self,  environment, time):
...
# -------------------------------------------------------------------------
    ...
    #         random_bank = environment.get_agent_by_id(environment.get_agent_by_id(ration[1].identifier).bank_acc) ####### NEW CODE
    ...
    # # -------------------------------------------------------------------------
    # def net_loans_deposits(self,  environment, time): ######### NEW CODE
    #     # We do it from the bank's perspective
    #     for bank in environment.banks:
    #         # And first go through the firms
    #         for firm in environment.firms:
    #             if firm.bank_acc == bank.get_identifier():
    ...
    #             elif (firm.bank_acc != bank.get_identifier()) & (time % 2 == 0):
    #                 # Finding what their balance of deposits (+) and loans (-) is
    #                 balance = 0.0
    #                 # And mark all the loan and deposits we account for to be deleted
    #                 to_delete = []
